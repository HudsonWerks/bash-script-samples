...
# Script for showing the current local time and the current distance from a given coordinate for the International Space Station. Requires Python script ISS-current-distance.py.
